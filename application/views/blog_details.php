   						...
   						<div class="col-lg-8 col-xl-8">
   							...
   							<div class="recent-news blog-lg">
   								<div class="action-box blog-lg">
   									<img src="<?php echo base_url();?>assets/images/blog/default/thum1.jpg" alt="">
   								</div>
   								<div class="info-bx">
   									<ul class="media-post">
   										...
   										<ol class="comment-list">
   											<li class="comment">
   												<div class="comment-body">
   													<div class="comment-author vcard"> <img  class="avatar photo" src="<?php echo base_url();?>assets/images/testimonials/pic1.jpg" alt=""> <cite class="fn">John Doe</cite> <span class="says">says:</span> </div>
   												...
   												<ol class="children">
   													<li class="comment odd parent">
   														<div class="comment-body">
   															<div class="comment-author vcard"> <img  class="avatar photo" src="<?php echo base_url();?>assets/images/testimonials/pic2.jpg" alt=""> <cite class="fn">John Doe</cite> <span class="says">says:</span> </div>
   															<div class="comment-meta"> <a href="#">December 02, 2019 at 10:45 am</a> </div>
   														...
   														<ol class="children">
   															<li class="comment odd parent">
   																<div class="comment-body">
   																	<div class="comment-author vcard"> <img  class="avatar photo" src="<?php echo base_url();?>assets/images/testimonials/pic3.jpg" alt=""> <cite class="fn">John Doe</cite> <span class="says">says:</span> </div>
   																	<div class="comment-meta"> <a href="#">December 02, 2019 at 10:45 am</a> </div>
   																	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet. 
   																		In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis, 
   																		ac elementum ligula blandit ac.</p>
   						...
   						<div class="col-lg-4 col-xl-4">
   							<aside  class="side-bar sticky-top">
   								...
   								<div class="widget recent-posts-entry">
   									...
   									<div class="widget-post-bx">
   										<div class="widget-post clearfix">
   											<div class="ttr-post-media"> <img src="<?php echo base_url();?>assets/images/blog/recent-blog/pic1.jpg" width="200" height="143" alt=""> </div>
   											<div class="ttr-post-info">
   												<div class="ttr-post-header">
   													<h6 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>">This Story Behind Education Will Haunt You Forever.</a></h6>
   												</div>
   												<ul class="media-post">
   										...
   										<div class="widget-post clearfix">
   											<div class="ttr-post-media"> <img src="<?php echo base_url();?>assets/images/blog/recent-blog/pic2.jpg" width="200" height="160" alt=""> </div>
   											<div class="ttr-post-info">
   												<div class="ttr-post-header">
   													<h6 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>">What Will Education Be Like In The Next 50 Years?</a></h6>
   												</div>
   												<ul class="media-post">
   													<li><a href="#"><i class="fa fa-calendar"></i>May 14 2019</a></li>
   										...
   										<div class="widget-post clearfix">
   											<div class="ttr-post-media"> <img src="<?php echo base_url();?>assets/images/blog/recent-blog/pic3.jpg" width="200" height="160" alt=""> </div>
   											<div class="ttr-post-info">
   												<div class="ttr-post-header">
   													<h6 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>">Eliminate Your Fears And Doubts About Education.</a></h6>
   												</div>
   												<ul class="media-post">
   								...
   								<div class="widget widget_gallery gallery-grid-4">
   									...
   									<ul>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic2.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic1.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic5.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic7.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic8.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic9.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic3.jpg" alt=""></a></div></li>
   										<li><div><a href="#"><img src="<?php echo base_url();?>assets/images/gallery/pic4.jpg" alt=""></a></div></li>
   									</ul>
   								</div>
