				...
				<div class="container">
					<div class="ttr-blog-grid-3 row" id="masonry">
						<div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							<div class="recent-news">
								<div class="action-box">
									<img src="<?php echo base_url();?>assets/images/blog/latest-blog/pic1.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
									...
									<h5 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>">This Story Behind Education Will Haunt You Forever.</a></h5>
						...
						<div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							<div class="recent-news">
								<div class="action-box">
									<img src="<?php echo base_url();?>assets/images/blog/latest-blog/pic2.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
						...
						<div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							<div class="recent-news">
								<div class="action-box">
									<img src="<?php echo base_url();?>assets/images/blog/latest-blog/pic3.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
									...
									<h5 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>">Master The Skills Of Education And Be.</a></h5>
						...
						<div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							<div class="recent-news">
								...
								<div class="info-bx">
									...
									<h5 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>">Eliminate Your Fears And Doubts About Education.</a></h5>
						...
						<div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							<div class="recent-news">
								...
								<div class="info-bx">
									...
									<h5 class="post-title"><a href="<?php echo site_url('Media/blog_details');?>
									">Seven Reasons You Should Fall In Love With Education.</a></h5>
						...
						<div class="post action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							<div class="recent-news">
								...
								<div class="info-bx">
									...
									<h5 class="post-title"><a href="b<?php echo site_url('Media/blog_details');?>log-details.html">The Biggest Contribution Of Education To Humanity.</a></h5>
